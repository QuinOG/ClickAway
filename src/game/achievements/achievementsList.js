...
export const ACHIEVEMENT_CATEGORIES = [
  ...
  { key: "skill", label: "Skill", isCoreCategory: true },
  ...
  skill: [
    {
      id: "skill-clean-1",
      title: "Flawless",
      description: "Complete a round with 0 misses (5+ hits).",
      iconKey: "skill",
    ...
    },
    {
      ...
      description: "Complete 10 rounds with 0 misses (5+ hits).",
      iconKey: "skill",
      metricKey: "cleanRounds",
      targetValue: 10,
    },
    {
      id: "skill-clean-25",
      title: "Zero Fault",
      description: "Complete 25 rounds with 0 misses (5+ hits).",
      iconKey: "skill",
      metricKey: "cleanRounds",
      targetValue: 25,
    },
    {
      ...
      title: "Sharp Eye",
      description: "Achieve 90%+ accuracy in a single round (10+ attempts).",
      iconKey: "skill",
      metricKey: "bestSingleRoundAccuracy",
      targetValue: 90,
    },
    {
      id: "skill-accuracy-95",
      title: "Precision Lock",
      description: "Achieve 95%+ accuracy in a single round (10+ attempts).",
      iconKey: "skill",
      metricKey: "bestSingleRoundAccuracy",
      targetValue: 95,
    },
    {
      id: "skill-ranked-streak-15",
      title: "Ranked Combo",
      description: "Reach a 15+ streak in a ranked round.",
      iconKey: "skill",
      metricKey: "bestRankedStreak",
      targetValue: 15,
    },
    {
      id: "skill-ranked-streak-25",
      title: "Ranked Commander",
      description: "Reach a 25+ streak in a ranked round.",
      iconKey: "skill",
      metricKey: "bestRankedStreak",
      targetValue: 25,
    },
    {
      id: "skill-consec-wins-3",
      title: "On a Roll",
      description: "Win 3 ranked rounds in a row.",
      iconKey: "skill",
      metricKey: "maxConsecutiveRankedWins",
      targetValue: 3,
    },
    {
      id: "skill-consec-wins-5",
      title: "Momentum",
      description: "Win 5 ranked rounds in a row.",
      iconKey: "skill",
      metricKey: "maxConsecutiveRankedWins",
      targetValue: 5,
    },
    {
      id: "skill-score-100",
      title: "Century",
      description: "Score 100 or more in a single round.",
      iconKey: "skill",
      metricKey: "bestSingleScore",
      targetValue: 100,
    },
    {
      id: "skill-score-200",
      title: "Double Century",
      description: "Score 200 or more in a single round.",
      iconKey: "skill",
      metricKey: "bestSingleScore",
      targetValue: 200,
    },
